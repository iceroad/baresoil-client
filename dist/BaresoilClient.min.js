...
*/
function d(a){var b={serverUrl:"object"==typeof window?"/__bs__/live":void 0,connectPolicy:"auto"};a=a||{};if("object"!=typeof a)throw Error("options must be provided as an object.");for(var c in b)c in a||(a[c]=b[c]);if(!a.serverUrl)throw Error('"serverUrl" must be specified in options.');if("string"!=typeof a.serverUrl||!a.serverUrl.match(/^https{0,1}:\/\//i)&&!a.serverUrl.match(/^wss{0,1}:\/\//i))throw Error('Invalid "serverUrl" parameter: '+serverUrl);if("auto"!==a.connectPolicy&&"immediate"!==
a.connectPolicy&&"manual"!==a.connectPolicy)throw Error('Invalid "connect" parameter: '+a.connectPolicy);this.D={connecting:this.o.bind(this),setup:this.B.bind(this),connected:this.v.bind(this),error:this.w.bind(this),offline:this.A.bind(this)};this.sessionPacket=a.sessionPacket;this.serverUrl=a.serverUrl;this.s=a;this.h="offline";this.a={};this.g={};this.u=1;this.f=0;this.l=[];"immediate"===a.connectPolicy&&this.connect()}
