...
l.data,w),this.c=w,k(this,"error"),c=!0,f.removeListener("message",b),f.removeListener("close",a)}}.bind(this);a=function(g){if(!c){var h=r[g.code]||"internal_error";this.c=new e.ConnectionTerminatedError(h,d?d.message:g.reason,d?d.C:0);f.removeListener("message",b);f.removeListener("close",a);"retry_later"===h?(this.f=n(this.f),k(this,"connecting")):k(this,"error",this.c);c=!0}}.bind(this);f.addEventListener("close",a.bind(this));f.addEventListener("message",b.bind(this));var g=this.m;g.length&&
(g.forEach(this.o.bind(this)),g.splice(0,g.length))};e.prototype.l=function(){this.b&&(this.b.close(),delete this.b);var a=this.c;this.c=a;for(var b in this.i)(0,this.i[b])(a||Error("BaresoilClient: client state reset."));this.i={};this.g="error";this.m=[];this.f=0};
...
{requestId:f,"function":a,arguments:b}];"connected"===d?this.o(a):this.m.push(a)}"offline"!==d&&"init"!==d||"auto"!==this.s||this.connect()};e.prototype.close=function(){this.b&&(this.b.removeAllListeners(),this.b.close(),delete this.b);k(this,"offline")};e.prototype.on=function(a,b){this.a[a]=this.a[a]||[];this.a[a].push([b,!0]);return b};e.prototype.once=function(a,b){this.a[a]=this.a[a]||[];this.a[a].push([b,!1]);return b};
e.prototype.removeEventListener=function(a,b){if("function"!==typeof b)throw Error("removeEventListener() must be called with a function reference.");this.a[a]&&(this.a[a]=this.a[a].filter(function(a){return a!==b}))};e.prototype.removeAllListeners=function(a){a?delete this.a[a]:this.a={}};e.prototype.getConnectionStatus=function(){return this.g};e.prototype.getError=function(){return this.c};
e.prototype.h=function(){var a=Array.prototype.slice.call(arguments);if(1>a.length)throw Error("emit() requires at least one argument.");var b=a[0],c=a.slice(1),d=[];this.a[b]&&(this.a[b]=this.a[b].filter(function(a){d.push([a[0],c]);return a[1]}));this.a["*"]&&(this.a["*"]=this.a["*"].filter(function(b){d.push([b[0],a]);return b[1]}));d.forEach(function(a){a[0].apply(this,a[1])})};e.prototype.o=function(a){this.h("outgoing_message",a);this.b.send(JSON.stringify(a))};
