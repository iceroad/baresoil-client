...
e.prototype.B=function(){var a,b,c,d,f=this.b;b=function(g){if(!c)try{var l=JSON.parse(g.data),h=l[0];this.h("incoming_message",l);if("session_response"===h)l[1]&&(this.u=l[1]),c=!0,f.removeListener("message",b),f.removeListener("close",a),k(this,"connected");else if("end_connection"===h||"error"===h)this.c=l[1],d=l[2],k(this,"error");else if("user_event"===h)this.h.apply(this,l);else throw Error("Unknown command: "+h);}catch(v){this.c=v,k(this,"error"),c=!0,f.removeListener("message",b),f.removeListener("close",
a)}}.bind(this);a=function(g){if(!c){var l=q[g.code]||"internal_error";this.c=new e.ConnectionTerminatedError(l,d?d.message:g.reason,d?d.C:0);f.removeListener("message",b);f.removeListener("close",a);"retry_later"===l?(this.f=n(this.f),k(this,"connecting")):k(this,"error",this.c);c=!0}}.bind(this);f.addEventListener("close",a.bind(this));f.addEventListener("message",b.bind(this));this.s(["session_request",this.u||null])};
e.prototype.A=function(){var a,b,c,d,f=this.b;b=function(l){if(!c)try{var h=JSON.parse(l.data),g=h[0];if("rpc_response"===g){var m=h[1],r=m.requestId,t=this.i[r];if(t){delete this.i[r];var p;"object"===typeof m.error&&(p=Error(),p.message=m.error.message);t.call(this,p,m.result)}this.h.apply(this,h)}else if("user_event"===g)this.h.apply(this,h);else if("end_connection"===g)d=h[1],this.h.apply(this,h);else throw Error("Unknown command from server: "+g);}catch(u){console.error("BaresoilClient: invalid packet from server during session:",
l.data,u),this.c=u,k(this,"error"),c=!0,f.removeListener("message",b),f.removeListener("close",a)}}.bind(this);a=function(g){if(!c){var h=q[g.code]||"internal_error";this.c=new e.ConnectionTerminatedError(h,d?d.message:g.reason,d?d.C:0);f.removeListener("message",b);f.removeListener("close",a);"retry_later"===h?(this.f=n(this.f),k(this,"connecting")):k(this,"error",this.c);c=!0}}.bind(this);f.addEventListener("close",a.bind(this));f.addEventListener("message",b.bind(this));var g=this.o;g.length&&
(g.forEach(this.s.bind(this)),g.splice(0,g.length))};e.prototype.m=function(){this.b&&(this.b.close(),delete this.b);var a=this.c;this.c=a;for(var b in this.i)(0,this.i[b])(a||Error("BaresoilClient: client state reset."));this.i={};this.g="error";this.o=[];this.f=0};
var q={1E3:"close_normal",1001:"retry_later",1002:"protocol_error",1003:"protocol_error",1005:"retry_later",1006:"retry_later",1007:"protocol_error",1008:"policy_violation",1009:"policy_violation",1010:"protocol_error",1011:"internal_error",1012:"retry_later",1013:"retry_later"};
